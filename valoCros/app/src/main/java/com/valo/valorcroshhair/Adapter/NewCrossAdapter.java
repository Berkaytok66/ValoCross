...
public class NewCrossAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context mContext;
    ...
    public NewCrossAdapter(Context mContext, ArrayList<AdminVeriEkle> adminVeriEkleArrayList, RecyclerView recyclerView) {
    ...
    @NonNull
    @Override
    public NewCrossHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = null;
        if (viewType == 1){
            view =  LayoutInflater.from(mContext).inflate(R.layout.ana_sayfa_croslar,parent,false);
            return new NewCrossAdapter.NewCrossHolder(view);
        }else if (viewType ==2){
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof NewCrossAdapter.NewCrossHolder){
            final NewCrossAdapter.NewCrossHolder myMenuHolder = (NewCrossAdapter.NewCrossHolder) holder;
        ...
        } else if (holder instanceof NewCrossAdapter.ViewHolderLoading){
            NewCrossAdapter.ViewHolderLoading viewHolderLoading = (NewCrossAdapter.ViewHolderLoading) holder;
    ...
    public class NewCrossHolder extends RecyclerView.ViewHolder{
        ...
        Button btnCopy;
        public NewCrossHolder(@NonNull View itemView) {
            super(itemView);
