...
public class NewCrossFragment extends Fragment {
    ...
    private NewCrossAdapter myAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view =  inflater.inflate(R.layout.fragment_new_cross, container, false);
        init();
        RecyclerViewSetting();
    ...
    private void RecyclerViewSetting(){
        ...
        myAdapter = new NewCrossAdapter(view.getContext(),mList,recyclerView);
    ...
    private void FirebaseRecyclerViewVeriAktarimi() {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Pro");
